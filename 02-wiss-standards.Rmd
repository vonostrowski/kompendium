...
\hangpara{0.5in}{1}Rijkaard, T. (1998). *Vom Entstehen einer Sprache* (3. Aufl.). Berlin:
Hauser.
...
\hangpara{0.5in}{1}Othendorf, D. (Hrsg.). (1954). *Neue Wege zur Mathematik: Ein
Überblick*. Leipzig: Siebald.
...
Abschnitt [Software](#sec:software) nutzen, um diese Informationen zu erfassen.
...
Datenbankeinträgen beziehen. Die Standardzitierweise von
LaTeX entspricht nicht den APA-Standards und sollte daher nicht
verwendet werden.
